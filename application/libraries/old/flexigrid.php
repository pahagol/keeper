...
class Flexigrid {
     ...
     */
    public function json_build($record_count, $data = null, $sums = null) {
        //Creates new Data Set and sends all the information
        $fg_data_set = new Fg_data_set($record_count, $this->post_info['page'], $data, $sums);
...
class Fg_data_set {
     ...
     * @param	processed data that is going to the grid
     */
    public function Fg_data_set($record_count, $page, &$data, &$sums) {
        //Set initial params
