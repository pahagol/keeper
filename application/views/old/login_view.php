...
<div  id="login_container">
    <div  id="header">
	    ...
	    <div id="login" class="section">
			<a style="font-weight: bold;color:green;margin-right:10px" href="help/about">О нас</a>
			<a style="font-weight: bold;color:green;margin-right:10px" href="help/faq">FAQ</a>
			<a style="font-weight: bold;color:green;margin-right:10px" href="help/contact">Контакты</a>
			...
			<br />
			<strong>Запомнить</strong><input type="checkbox" id="remember" class="input noborder" /> 
			
			<br />
            <p style="text-align: center;font-size:16px;">
				<a href="register" style="font-weight: bold;color:green;float:right;">Регистрация</a>
			</p>
            <br />
			...
			<a href="register/forgot" id="passwordrecoverylink">Забыли логин или пароль?</a>
	    </div>
