<div class="data-item">
	...
	<? if ($dictionaries): ?>
		...
		<tr id="tr-dictionaryExpenseName-<?=$dictionary->id?>">
			...
			<td class="view-action" onclick="moduleOption.delDialog(<?=$dictionary->id?>, 'dictionaryExpenseName')" title="Удалить"></td>
		</tr>
		<? endforeach; ?>
	<? endif ?>
		<tr>
...
<div class="data-item">
	...
	<? if ($categories): ?>
		...
		<tr id="tr-category-<?=$category->id?>">
			...
			<td class="view-action" onclick="moduleOption.delDialog(<?=$category->id?>, 'category')" title="Удалить"></td>
		</tr>
		<? endforeach; ?>
	<? endif ?>
		<tr>
...
<div class="data-item">
	...
	<? if ($owners): ?>
		...
		<tr id="tr-owner-<?=$owner->id?>">
			...
			<td class="view-action" onclick="moduleOption.delDialog(<?=$owner->id?>, 'owner')" title="Удалить"></td>
		</tr>
		<? endforeach; ?>
	<? endif ?>
		<tr>
