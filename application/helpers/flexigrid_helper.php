...
if (! function_exists('build_grid_js'))
{
	...
	function build_grid_js($grid_id,$url,$colModel,$sortname,$sortorder,$gridParams = NULL,$buttons = NULL)
	{
		...
		//Finalize
		$grid_js .= "});";
        $append="<li style=\"float:right;\"><form action=\"$url\" method=\"post\"><input type=\"hidden\" name=\"excel\" value=\"1\"/><input type=\"hidden\" name=\"dataType\" value=\"json\"/><input type=\"hidden\" name=\"sortname\" value=\"$sortname\"/><input type=\"hidden\" name=\"sortorder\" value=\"$sortorder\"/><input type=\"hidden\" name=\"rp\" value=\"10000000000000\"/><input type=\"submit\" value=\"Export to Excel\"/></form></li>";
        $grid_js.="$('.sf-menu').append('$append');});</script>";
